...
def parse_args():
    ...
    parser.add_argument('-c', help='parse individual content or not', type=boolean_string, default=False)
    ...
    parser.add_argument('-cp', help='path to save your csv file', default='dcard.csv')
    parser.add_argument('-xp', help='path to save your xlsx file', default='dcard.xlsx')
...
if __name__ == '__main__':
    ...
    dcard.fetch()
    if args.cp:
        dcard.to_csv(ROOT+args.cp)
    if args.xp: 
        dcard.to_xlsx(ROOT+args.xp)
